...
class IPlayer:
    ...
    def start(self, is_starting: bool) -> Map:
        """
        Be informed if the tournament has started and return a map that could be used for the tournament
        :param is_starting: whether a tournament is starting
        :return: a map
        """
        raise NotImplementedError()
    ...
    def end(self, has_won: bool) -> None:
        """
        Be informed if this player has won the tournament
        """
        raise NotImplementedError()