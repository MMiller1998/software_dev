...
class RandomDestinationOptionsStrategyTests(unittest.TestCase):
    ...
    def test_order_destinations(self):
        ...
        self.assertTrue(self.DEST_1 in destinations)
        self.assertTrue(self.DEST_2 in destinations)
        self.assertTrue(self.DEST_3 in destinations)
        self.assertTrue(self.DEST_4 in destinations)
        self.assertTrue(self.DEST_5 in destinations)
