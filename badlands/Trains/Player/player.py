...
class Player(IPlayer):
    """
    Represents a player in the Trains game
    ...
    """
    def __init__(self, strategy: Type[IStrategy]):
    ...
    @staticmethod
    def player_from_strategy_file(strategy_file: str) -> 'Player':
        """
        ...
        """
        return Player(AStrategy.from_file(strategy_file))
